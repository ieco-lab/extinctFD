...
load(file = file.path(here::here(), "data", "maxsvl.rda"))
...
if(svl.correct == TRUE && use.svl == TRUE){
  #default uses both
  load(file = file.path(here::here(), "data", "dat_pca_tidy.rda"))
  ...
  #no svl in pca
  load(file = file.path(here::here(), "data", "dat_pca_tidy_nosvl.rda"))
  #recode to leio to make it easier
  ...
  #no scaling version
  load(file = file.path(here::here(), "data", "dat_pca_tidy_norescale.rda"))
   #recode to leio to make it easier
  ...
  load(file = file.path(here::here(), "data", "dat_pca_tidy_nosvl_norescale.rda"))
  #recode to leio to make it easier
...
if(svl.correct == TRUE && use.svl == TRUE){
  #default uses both
load(file = file.path(here::here(), "data", "sim_extinction_present_pc1.rda"))
load(file = file.path(here::here(), "data", "sim_extinction_present_pc2.rda"))
...
sim_extinction_pc2 <- sim_extinction_present_pc2
  ...
  #default uses both
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc1_nosvl.rda"))
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc2_nosvl.rda"))
  #assign the sim data to correpsonding objects
...
#sim_extinction_pc2 <- sim_extinction_present_pc2_nosvl
  ...
  #default uses both
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc1_norescale.rda"))
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc2_norescale.rda"))
  #assign the sim data to correpsonding objects
...
#sim_extinction_pc2 <- sim_extinction_present_pc2_norescale
  ...
  #default uses both
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc1_nosvl_norescale.rda"))
#load(file = file.path(here::here(), "data", "sim_extinction_present_pc2_nosvl_norescale.rda"))
  #assign the sim data to correpsonding objects
...
load(file = file.path(here::here(), "data", "empirical_extinct_reps_pca.rda"))
...
load(file = file.path(here::here(), "data", "rep_emp_pc1.rda"))
...
load(file = file.path(here::here(), "data", "rep_emp_pc2.rda"))
