...
load(file = file.path(here::here(), "data", "iucn.rda"))
...
load(file = file.path(here::here(), "data", "sim_extinction.rda"))
load(file = file.path(here::here(), "data", "sim_extinction_past.rda"))
load(file = file.path(here::here(), "data", "sim_extinction_present.rda"))
...
load(file = file.path(here::here(), "data", "empirical_extinct_reps.rda"))
# load data files
...
load(file = file.path(here::here(), "data", "rep_emp_svl.rda"))
...
load(file = file.path(here::here(), "data", "rep_emp_present_svl.rda"))
